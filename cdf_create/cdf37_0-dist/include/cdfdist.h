...
*                               cdfid_FreeMemory.
*   V2.19 09-Jan-18, M Liu      Added ARM and IA64 openVMS architectures
*                               support.
*
******************************************************************************/
...
#if defined(vms) && defined(__ia64__)
#  define vmsIA64
#  if __D_FLOAT
#    define ia64vmsD
#  endif
...
*              ARM, IA64 (OpenVMS - IEEE_FLOAT)
*   3..........VAX, Alpha and IA64 (OpenVMS - D_FLOAT)
*   4..........Alpha and IA64 (OpenVMS - G_FLOAT)
*****************************************************************************/
...
#  define FP1cpu
    ...
    defined(alphavmsI) || defined(posixSHELLalphaI) || defined(ARM) || \
    defined(ia64vmsI)
#  define FP2cpu
#endif
...
#define ENTRY_NUMSTRINGS(zOp) BOO(zOp,zENTRY_NUMSTRINGS_,rENTRY_NUMSTRINGS_)
#define ENTRY_STRINGDATA(zOp) BOO(zOp,zENTRY_STRINGDATA_,rENTRY_STRINGDATA_)
