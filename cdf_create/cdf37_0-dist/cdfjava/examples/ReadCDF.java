	...
	if (args.length != 0) fileName = args[ii];
	  ...
	  cdf = null;
                    ...
                    if (entry != null) {
                       ...
                       if (eDataType == CDF_EPOCH) {
                          ...
                          if (entry.getScope() == VARIABLE_SCOPE &&
                              CDFUtils.isStringDataType(eDataType)) {
		...
		// if (v.checkPadValueExistence()) {
                  ...
                  System.out.print (" PadValue="+((CDFUtils.isStringDataType(dt)||CDFUtils.isEpochDataType(dt))?"\"":"")+padValue+((CDFUtils.isStringDataType(dt)||CDFUtils.isEpochDataType(dt))?"\"":""));
                // }
